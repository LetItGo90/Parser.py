...
def process_folder(folder_path, output_csv):
    all_rules = []
    rule_files = [f for f in os.listdir(folder_path) if f.lower().endswith('.rule')]
    ...
    print(f"Found {total} rule files\n")
    ...
    if all_rules:
        ...
        print(f"Done! Wrote {len(all_rules)} rules to {output_csv}")
